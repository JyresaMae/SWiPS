  ...
  switch (topic) {
    ...
    case 'swips/detection': {
      ...
      if (isLocal) {
        ...
        liveState.vehicleCount    = data.vehicle || 0;
        ...
        liveState.vehicleInCrosswalk = data.vehicleInCrosswalk || false;
        liveState.vehicleInCrosswalkCount = data.vehicleInCrosswalkCount || 0;
      }
      ...
      if (isLocal) {
        ...
        if (data.safetyLevel) {
          ...
          if (liveState.crosswalkState === 'OBSTRUCTION' || liveState.vehicleInCrosswalk || liveState.activeAlerts > 5)
        ...
        if (shouldLogFrame) {
          ...
          const framePoint = new Point('detection_frame')
            ...
            .intField('vehicle', data.vehicle || 0)
    ...
    case 'swips/alert': {
      ...
      switch (data.type) {
        ...
        case 'OBSTRUCTION':
          ...
          break;
        case 'VEHICLE_IN_CROSSWALK':
          violationState.today.vehicleInCrosswalk++;
          break;
      ...
      const point = new Point('alert')
        ...
        .intField('vehicleCount', data.vehicleCount || 0)
...
app.get('/api/alerts/export.csv', async (req, res) => {
  ...
  try {
    ...
    const header = [
      ...
      'message', 'pedestrian_count', 'jaywalker_count', 'vehicle_count',
