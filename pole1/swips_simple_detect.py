...
# CONFIG
# ══════════════════════════════════════════════════════════════
RTSP        = os.environ.get("SWIPS_RTSP", "rtsp://admin:swips2026@192.168.1.242:554/stream2")
    ...
    while True:
        ...
        if mode == "OBSTRUCTION" and prev_mode != "OBSTRUCTION":
            if can_fire_alert("OBSTRUCTION"):
                ...
                print(f"  ⚠ CRITICAL: OBSTRUCTION | peds={peds_in_cw} | snap={snap}", flush=True)
...
# ══════════════════════════════════════════════════════════════
# THREAD 2: Video (camera → annotate → FFmpeg → JSMpeg)
# ══════════════════════════════════════════════════════════════
def video_thread():
    global latest_frame
